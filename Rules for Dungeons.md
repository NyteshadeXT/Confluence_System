...
|---|---|---|
|Slot 1|Core Concept|At-Will|
|Slot 2|Utility/Passive|Passive or Conditional|
|Slot 3|Signature Strike|Encounter (Attack)|
|Slot 4|Tactical Strike|Encounter (Attack)|
|Slot 5|Apex Ability|Daily|

The resulting total build at max rank is: 4 At-Wills, 4 Utility/Passives, 8 Encounter Attacks, 4 Dailies. However, not all 20 slots available or “online” at once.  While characters may unlock up to eight Encounter powers, only four are ever active at a time—one per Essence.  All other Encounter Attacks are latent and can be swapped during rests.

Once acquired, an Essence cannot be removed casually.  Replacing an Essence requires a major ritual as well as narrative justification and GM approval.  The character’s Awakened slots remain awakened even if the Essence changes but become dormant until a compatible Essence is installed or a ritual converts them.
...
|**Rarity**|**World Response**|**Design Purpose**|
|---|---|---|
|Common|Accepted|Baseline play|
|Uncommon|Conditional|Specialization|
|Rare|Resistant|Strong identity|
|Mythic|Hostile|Campaign-defining|

**Common Essence** is easy to awaken with no associated costs and have a wide variety of options for Awakening Stones. These form the expected baseline for most characters.
...
A Confluence Essence occupies the fourth Essence slot and cannot exist without its contributing Essences.

A character with one or more Divine Essences will find that it alters the Confluence slot’s behavior forcing it to become a Divine Confluence Essence. Divinity reshapes identity, it doesn’t just add tools.
...
Rare Awakening Stones are usually situational, identity-defining expressions.  They are highly specific and very strong when the right conditions are met.  Rare Awakening Stones are typically tuned to a single Essence or require a Confluence Essence.

Finally, Mythic Awakening Stones are singular, world-pushing expressions.  They are extremely rare and carry narrative weight.  Many, but not all, are tied to Divine, Confluence, or Dungeon-unique Essences.
...
**Character Tier Rule** A character’s Tier is equal to the lowest Tier among all Essences they possess.

**When all powers and Essences have reached Rank 10 in a Tier:**
- The character advances to the next Tier
- All powers reset to Rank 0 in the new Tier
- New Tier expressions become available
- Tier-based math adjustments (accuracy, defenses, flat damage) apply
...
**Essence Tier Gate** An Essence also cannot advance to the next Tier until all of its linked powers have reached Rank 10 in the current Tier.
...
Once all a characters Essences have moved to the next Tier the character is also considered to have progressed.  Using the example above, once all the characters Essences become Bronze ranked that character is also considered a Bronze ranked character.
...
## Spending XP
Experience earned from Dungeon challenges is not applied automatically.  Players choose when and where to invest XP in eligible powers, subject to Rank and Tier restrictions, but is always spent to increase the Rank of a specific power. Ranks progress from 0 to 10 within the current Tier. It is never applied to Essences or to the character as a whole. 

XP that is not spent remains unassigned. Investing XP in a power immediately increases that power’s Rank once the XP cost is met. XP spent on a power is permanently committed and does not transfer between powers.
...
Certain circumstances may cause a ritual to fail even when performed correctly with all the correct materials.  Combining incompatible Essences, attempting to force a Confluence to coalesce early, stabilizing a forbidden Confluence or attempting to override a Dungeons resistance are all instances that will likely result in ritual failure. This could result in a spike in Dungeon Awareness, a Confluence Essence or slot remaining dormant or even an Essence failing to bind.