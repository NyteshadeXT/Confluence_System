...
actions:
  - name: Bite (single; at-will)
    desc: "*Attack* melee (one creature); `dice: 1d20+7|form` +7 vs. AC; *Hit* `dice: 1d8+6|form` damage, and the target is [[slowed]] until the end of the sporback's next turn."
  - name: Barbed Tongue (double; at-will)
    desc: "*Attack* melee (one creature, reach 3); `dice: 1d20+5|form` +5 vs Reflex; *Hit* `dice: 2d6+2|form` damage, and the sporeback pulls the target 2 squares knocking it prone in the process."
legendary_actions:
  - name: 
    desc: 
  - name: 
