...
actions:
  ...
  - name: Impaling Thorn (single; recharges when the bloodthorn vine doesn’t have a creature grabbed) ✦ Healing
    desc: "The vine impales the target’s flesh with a thorn: `dice: 1d20+9|form` +9 vs. Fortitude; `dice: 1d8+4|form` damage, and the target is [[Conditions#Grabbed|Grabbed]]. **Sustain** *Double* The vine sustains the grab, the target takes `dice: 2d8+4|form` damage, and the vine regains 5 hit points."
